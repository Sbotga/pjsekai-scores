...
class Main:
    ...
    def from_args(cls) -> "Main":
        ...
        parser.add_argument(
            "--rebase", metavar="<xxx.json>", help="customized bpm, beats and sections"
        )
    ...
    def __call__(self):
        ...
        d = Drawing(
            score=s, lyric=self.lyric, style_sheet=self.css, note_host=self.note_host
        )
